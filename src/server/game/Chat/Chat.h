...
class ChatHandler
{
    ...
    protected:
        ...
        bool HandleDisableSpellCommand(const char* args);
        ...
        bool HandleFlyCheatCommand(const char* args);
        ...
        bool HandleNudgeXCommand(const char* args);
        bool HandleNudgeYCommand(const char* args);
        bool HandleNudgeZCommand(const char* args);
        ...
        bool HandleNoModifyCommand(const char* args);
        bool HandleToggleSummonCommand(const char* args);
        bool HandleToggleAppearCommand(const char* args);
        bool HandleAllCheatsCommand(const char* args);
        bool HandleNoAnnounceCommand(const char* args);
