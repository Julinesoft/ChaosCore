...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    {
        { "recustomize",    SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleCharacterCustomizeCommand>,     "", NULL },
        ...
        { "getstanding",    SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleCharacterReputationCommand>,    "", NULL },
        //{ "settitle",       SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleCharacterTitlesCommand>,        "", NULL }, Todo: Fixme!
        ...
        { "advanceallskills",SEC_ADMINISTRATOR, false, OldHandler<&ChatHandler::HandleMaxSkillCommand>,               "", NULL },
        { "setstanding",    SEC_GAMEMASTER,     false, OldHandler<&ChatHandler::HandleModifyRepCommand>,              "", NULL },
        { NULL,             0,                  false, NULL,                                                          "", NULL }
    };
    ...
    {
        { "spell",          SEC_MODERATOR,      false,  OldHandler<&ChatHandler::HandleDisableSpellCommand>,"", NULL },
        { NULL,             0,                  false, NULL,                                                "", NULL }
    };

    static ChatCommand cheatCommandTable[] =
    {
        { "god",            SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleGodModeCheatCommand>, "", NULL },
        { "power",          SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandlePowerCheatCommand>,   "", NULL },
        { "all",            SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleAllCheatsCommand>,    "", NULL },
        { "casttime",       SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleCastTimeCheatCommand>,"", NULL },
        { "cooldown",       SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleCoolDownCheatCommand>,"", NULL },
        { "waterwalk",      SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleWaterWalkCheatCommand>,"", NULL },
        { "explore",        SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleExploreCheatCommand>,"", NULL },
        { "taxi",           SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleTaxiCheatCommand>,    "", NULL },
        { "fly",            SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleFlyCheatCommand>,     "", NULL },
        { "triggerpass",    SEC_ADMINISTRATOR,  false,  OldHandler<&ChatHandler::HandleTriggerPassCheatCommand>,"", NULL },
        { NULL,             0,                  false,  NULL,                                                "", NULL }
    };
    ...
    static ChatCommand lookupCommandTable[] =
    {
        ...
        { "port",           SEC_MODERATOR,      true,  OldHandler<&ChatHandler::HandleLookupTeleCommand>,          "", NULL },
    ...
    {
        { "x",        SEC_GAMEMASTER,           false, OldHandler<&ChatHandler::HandleNudgeXCommand>,              "", NULL },
        { "y",        SEC_GAMEMASTER,           false, OldHandler<&ChatHandler::HandleNudgeYCommand>,              "", NULL },
        { "z",        SEC_GAMEMASTER,           false, OldHandler<&ChatHandler::HandleNudgeZCommand>,              "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
    ...
    static ChatCommand petCommandTable[] =
    {
        ...
        { "talentpoints",   SEC_GAMEMASTER,     false, OldHandler<&ChatHandler::HandlePetTpCommand>,               "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
    ...
    {
        { "modify",         SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleNoModifyCommand>,                 "", NULL },
        { "summon",         SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleToggleSummonCommand>,             "", NULL },
        { "appear",         SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleToggleAppearCommand>,             "", NULL },
        { "allcheats",      SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleAllCheatsCommand>,                "", NULL },
        { "announce",       SEC_MODERATOR,      false, OldHandler<&ChatHandler::HandleNoAnnounceCommand>,               "", NULL },
        { NULL,             0,                  false, NULL,                                                "", NULL }
    };
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "toggle",         SEC_MODERATOR,      false, NULL,                                           "", toggleCommandTable   },
        { "nudge",          SEC_MODERATOR,      false, NULL,                                           "", nudgeCommandTable    },
        { "send",           SEC_MODERATOR,      true,  NULL,                                           "", sendCommandTable     },
        { "disable",        SEC_MODERATOR,      false, NULL,                                           "", disableCommandTable  },
        ...
        { "dealdamage",     SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleDamageCommand>,              "", NULL },
        { "worldport",      SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleWorldportCommand>,           "", NULL },
        ...
        /*{ "bindsight",      SEC_ADMINISTRATOR,  false, OldHandler<&ChatHandler::HandleBindSightCommand>,           "", NULL }, --Crashy
