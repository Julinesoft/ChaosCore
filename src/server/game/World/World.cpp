...
void World::SendWorldText(int32 string_id, ...)
{
    ...
    for (SessionMap::const_iterator itr = m_sessions.begin(); itr != m_sessions.end(); ++itr)
    {
        ...
        //If the player has disabled .announce, only show announcements made by admins.
        if (itr->second->GetPlayer()->NoAnnounce())
            continue;
...
// TODO: Remove this and put the functionality in SendWorldText
void World::ForceSendWorldText(int32 string_id, ...)
{
    va_list ap;
    va_start(ap, string_id);
