...
#pragma warning(default:4355)
    ...
    m_flyCheat = false;
    m_castTimeCheat = false;
    m_powerCheat = false;
    m_waterWalkCheat = false;
    m_coolDownCheat = false;
    m_taxiCheat = false;
    m_noModify = false;
    m_appearTo = false;
    m_summoned = false;
    m_exploreCheat = false;
    m_triggerPassCheat = false;
...
//GM Cheat States
bool Player::GodModeCheat()
{
    return m_godModeCheat;
}

bool Player::FlyCheat()
{
    return m_flyCheat;
}

bool Player::CastTimeCheat()
{
    return m_castTimeCheat;
}

bool Player::PowerCheat() 
{
    return m_powerCheat;
}

bool Player::WaterWalkCheat()
{
    return m_waterWalkCheat;
}

bool Player::CoolDownCheat() //TODO: This one doesn't work at all.
{
    return m_coolDownCheat;
}

bool Player::TaxiCheat()
{
    return m_taxiCheat;
}

bool Player::NoModify()
{
    return m_noModify;
}

bool Player::CantBeAppearedTo()
{
    return m_appearTo;
}

bool Player::CantBeSummoned()
{
    return m_summoned;
}

bool Player::NoAnnounce()
{
    return m_noAnnounce;
}

bool Player::TriggerPassCheat()
{
    return m_triggerPassCheat;
}

bool Player::ExploreCheat()
{
    return m_exploreCheat;
}
...
bool Player::CanAddItem(uint32 entry)
{
    QueryResult result = WorldDatabase.PQuery("SELECT * FROM item_disabled WHERE disabled = 1 and entry = %u", entry);
    if (result)
        return false;
    else
        return true;
...
bool Player::CanUseDI(uint32 entry)
{
    QueryResult result = WorldDatabase.PQuery("SELECT * FROM di_disabled WHERE disabled = 1 and entry = %u", entry);
    if (result)
        return false;
    else
        return true;
...
bool Player::CanSpawnNPC(uint32 entry)
{
    QueryResult result = WorldDatabase.PQuery("SELECT * FROM npc_disabled WHERE disabled = 1 and entry = %u", entry);
    if (result)
        return false;
    else
        return true;
...
bool Player::CanSpawnGob(uint32 entry)
{
    QueryResult result = WorldDatabase.PQuery("SELECT * FROM gob_disabled WHERE disabled = 1 and entry = %u", entry);
    if (result)
        return false;
    else
        return true;
...
bool Player::CanDeleteNPC(uint32 entry)
{
    QueryResult result = WorldDatabase.PQuery("SELECT * FROM creature_template WHERE entry=%u and candelete = 0", entry);
    if (result)
        return false;
    else
        return true;
...
//GM Cheat Toggles
void Player::TogglegodModeCheat()
{
    m_godModeCheat = !m_godModeCheat;
}

void Player::ToggleflyCheat()
{
    m_flyCheat = !m_flyCheat;
}

void Player::TogglecastTimeCheat()
{
    m_castTimeCheat = !m_castTimeCheat;
}

void Player::TogglepowerCheat()
{
    m_powerCheat = !m_powerCheat;
}

void Player::TogglewaterWalkCheat()
{
    m_waterWalkCheat = !m_waterWalkCheat;
}

void Player::TogglecoolDownCheat()
{
    m_coolDownCheat = !m_coolDownCheat;
}

void Player::ToggletaxiCheat()
{
    m_taxiCheat = !m_taxiCheat;
}

void Player::ToggleModify()
{
    m_noModify = !m_noModify;
}

void Player::ToggleAppear()
{
    m_appearTo = !m_appearTo;
}

void Player::ToggleSummon()
{
    m_summoned = !m_summoned;
}

void Player::TogglenoAnnounce()
{
    m_noAnnounce = !m_noAnnounce;
}

void Player::ToggletriggerPassCheat()
{
    m_triggerPassCheat = !m_triggerPassCheat;
}

void Player::ToggleExploreCheat()
{
    m_exploreCheat = !m_exploreCheat;
}
