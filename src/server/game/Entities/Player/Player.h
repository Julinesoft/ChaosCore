...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        bool m_godModeCheat;
        bool m_flyCheat;
        bool m_castTimeCheat;
        bool m_powerCheat;
        bool m_waterWalkCheat;
        ...
        bool NoModify();
        bool CantBeSummoned();
        bool CantBeAppearedTo();
        bool NoAnnounce();
        bool TriggerPassCheat();
        bool ExploreCheat();
        bool CanAddItem(uint32 entry);
        bool CanUseDI(uint32 entry);
        bool CanSpawnNPC(uint32 entry);
        bool CanSpawnGob(uint32 entry);
        bool CanDeleteNPC(uint32 entry);

        
        
        //GM Cheat Toggles
        void TogglegodModeCheat();
        void ToggleflyCheat();
        void TogglecastTimeCheat();
        void TogglepowerCheat();
        void TogglewaterWalkCheat();
        void TogglecoolDownCheat();
        void ToggletaxiCheat();
        void ToggleModify();
        void ToggleSummon();
        void ToggleAppear();
        void TogglenoAnnounce();
        void ToggletriggerPassCheat();
        void ToggleExploreCheat();
