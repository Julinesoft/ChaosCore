...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand gobjectCommandTable[] =
        {
            ...
            { "select",         SEC_GAMEMASTER,     false, &HandleGameObjectTargetCommand,    "", NULL },
            { "rotate",         SEC_GAMEMASTER,     false, &HandleGameObjectTurnCommand,      "", NULL },
            { "spawn",          SEC_GAMEMASTER,     false, &HandleGameObjectAddTempCommand,   "", NULL },
            { "permspawn",      SEC_GAMEMASTER,     false, &HandleGameObjectAddCommand,       "", NULL },
    ...
    static bool HandleGameObjectActivateCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (!lowguid && !cId)
            lowguid = handler->GetSession()->GetPlayer()->m_selectedGo;
        ...
        handler->GetSession()->GetPlayer()->m_selectedGo = lowguid;
        return true;
    }
    ...
    static bool HandleGameObjectDeleteCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->GetSession()->GetPlayer()->m_selectedGo = 0;
        return true;
    }
